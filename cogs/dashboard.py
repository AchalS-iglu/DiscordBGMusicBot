...
class Dashboard(commands.Cog, name='Dashboard'):
    ...
    async def newdb(self, ctx):
        ...
        embed2 = discord.Embed(title='Create a Dashboard!', description='Now we will define playlists links / music links / names coupled with the theme name for {} dashboard'.format(name), color = self.random_color)
